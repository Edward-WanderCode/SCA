# Hướng dẫn đóng góp cho SCA — Công Cụ Phân Tích Mã Nguồn Tĩnh
...
├── OpenGrep/         # Semgrep/OpenGrep engine (tải tự động)
├── Trivy/            # Trivy vulnerability scanner (tải tự động)
...
Xem [SECURITY.vi.md](SECURITY.vi.md) để biết cách báo cáo an toàn.
